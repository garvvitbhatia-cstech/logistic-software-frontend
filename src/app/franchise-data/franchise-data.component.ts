...
@Component({
  selector: 'app-franchise-data',
  templateUrl: './franchise-data.component.html',
  styleUrls: ['./franchise-data.component.css']
})
export class FranchiseDataComponent implements OnInit,OnDestroy {
